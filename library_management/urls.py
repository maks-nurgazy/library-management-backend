...
from users.views import SwaggerRedirectView
...
urlpatterns = [
    ...
    path('', SwaggerRedirectView.as_view()),

    # API urls
    path('api/v1/library/', include('library_app.api.urls')),
    path('api/v1/bookshelf/', include('book_shelf.api.urls')),
